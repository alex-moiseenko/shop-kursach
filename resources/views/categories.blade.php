    ...
    <div class="container gallery">
        <div class="row">
            <div class="col-6 col-sm-6 col-md-4 col-lg-3 gallerySections">
                <div>
                    <a href="{{url('/catalog/coats&jackets')}}">
            ...
            <div class="col-6 col-sm-6 col-md-4 col-lg-3 gallerySections">
                <div>
                    <a href="{{url('/catalog/sweatshirts')}}">
            ...
            <div class="col-6 col-sm-6 col-md-4 col-lg-3 gallerySections">
                <div>
                    <a href="{{url('/catalog/jumpers&Cardigans')}}">
            ...
            <div class="col-6 col-sm-6 col-md-4 col-lg-3 gallerySections">
                <div>
                    <a href="{{url('/catalog/accessories')}}">
